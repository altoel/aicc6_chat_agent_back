...
sudo rm -rf /var/www/fastapi-chat-back


echo "creating app folder"
sudo mkdir -p /var/www/fastapi-chat-back


echo "moving files to app folder"
sudo cp -r * /var/www/fastapi-chat-back/


# Navigate to the app directory and handle .env file
cd /var/www/fastapi-chat-back/
...
# 애플리케이션 디렉토리 권한 설정
sudo chown -R ubuntu:ubuntu /var/www/fastapi-chat-back
